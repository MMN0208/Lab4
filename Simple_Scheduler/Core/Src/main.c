...
void toggleYelLed(void);
void toggleGrnLed(void);
void toggleBluLed(void);
void toggleWhtLed(void);
/* USER CODE END PFP */
...
void toggleBluLed(void) {
	HAL_GPIO_TogglePin(BLU_0_GPIO_Port, BLU_0_Pin);
}

void toggleWhtLed(void) {
	HAL_GPIO_TogglePin(WHT_0_GPIO_Port, WHT_0_Pin);
}
/* USER CODE END 0 */
